    ...
    <>
            ...
            <div className="mt-8 space-y-5 text-sm">
              {[
                ...
                <div key={k} className="flex justify-between border-b border-primary-foreground/15 pb-3">
                  <span className="text-xs uppercase tracking-wider text-primary-foreground/60">{k}</span>
      ...
      <section className="border-y border-border bg-secondary/60 py-20">
        <div className="container-page grid gap-8 md:grid-cols-3">
          {[
            ...
            <div key={b.t} className="rounded-lg border border-border bg-card p-8 transition-all duration-300 hover:-translate-y-1.5 hover:border-gold/60 hover:shadow-elegant">
      ...
      <section className="border-t border-border bg-secondary/40 py-20">
        <div className="container-page grid gap-12 items-center lg:grid-cols-2">
          ...
          <img src={drivingForce} alt="WCM Ghana leadership" loading="lazy" className="w-full rounded-lg shadow-elegant" />
        </div>
      </section>
    </>
  );
